...
First official release of Teddy - a cross-platform tool for working with Toniebox audio files.
...
- **Windows**: `teddy-v1.0.0-win-x64.zip` or `teddybench-v1.0.0-win-x64.zip`
- **Linux**: `teddy-v1.0.0-linux-x64.tar.gz` or `teddybench-v1.0.0-linux-x64.tar.gz`
- **macOS (Intel)**: `teddy-v1.0.0-osx-x64.tar.gz` or `teddybench-v1.0.0-osx-x64.tar.gz`
- **macOS (Apple Silicon)**: `teddy-v1.0.0-osx-arm64.tar.gz` or `teddybench-v1.0.0-osx-arm64.tar.gz`
...
**Full Changelog**: https://github.com/BdN3504/teddy/commits/v1.0.0
