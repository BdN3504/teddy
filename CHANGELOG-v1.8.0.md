...
Enhanced cross-platform fork based on upstream v1.7.0 with modernized codebase and improved compatibility.
...
- **Windows**: `teddy-v1.8.0-win-x64.zip` or `teddybench-v1.8.0-win-x64.zip`
- **Linux**: `teddy-v1.8.0-linux-x64.tar.gz` or `teddybench-v1.8.0-linux-x64.tar.gz`
- **macOS (Intel)**: `teddy-v1.8.0-osx-x64.tar.gz` or `teddybench-v1.8.0-osx-x64.tar.gz`
- **macOS (Apple Silicon)**: `teddy-v1.8.0-osx-arm64.tar.gz` or `teddybench-v1.8.0-osx-arm64.tar.gz`
...
**Full Changelog**: https://github.com/BdN3504/teddy/commits/v1.8.0
